...
**It can be stated that the complexity increases with increasing of n and that why the execution time increases almost 20 times with increases of n.**
...
**It can be stated that the execution time of knapsack_dynamic is almost 1/4 times than brute force algorihtm **
...
so, **For large of n the execution time is larger than the time when n is small.**
...
However, **for smaller weight the execution time is small for the same number of values.**

**Question : ** How much time does it takes to run the algorithm for n = 500 objects?
**Answer : ** The execution time increases as the n increases by almost 9 times.
...
**Answer : **  The amount of time increases is almost 150% as compared to previous n.
...
![Brute Force Line Profiling](./brute.png)



![Dynamic Algorithm Line Profiling](./Dynamic.png)

![Greedy Hurestic Line Profiling](./greedy.png)
